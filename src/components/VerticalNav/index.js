    ...
    return (
        <div className='vertical-nav-bar'>
            <div className='vertical-nav-flex'>
                ...
                <a href='https://www.linkedin.com/in/brandon-phillips-2554801a1/' target='_blank' aria-label='LinkedIn'>
                    <i className="fab fa-linkedin-in nav-social-icon"></i>
                </a>
                <a href='https://github.com/BrandonP321' target='_blank' aria-label='GitHub'>
                    <i className="fab fa-github-alt nav-social-icon"></i>
                </a>
                <a href='https://stackoverflow.com/users/13790075/brandonp321' target='_blank' aria-label='Stack Overflow'>
